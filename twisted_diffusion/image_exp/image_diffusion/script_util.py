# Adapted from https://github.com/openai/guided-diffusion 

import argparse
import sys
import smc_diffusion as gd
from unet import UNetModel, EncoderUNetModel
from feynman_kac_image_ddpm import get_smc_ddpm
...
def model_and_diffusion_defaults():
    ...
    res.update({"sampler": "unconditional"})
    return res
...
def create_model_and_diffusion(
    ...
    """sampler determines the DDPM class to use"""
...
def create_gaussian_diffusion(
    *,
    ...
    return get_smc_ddpm(name=sampler, 
            particle_base_shape=image_shape,
