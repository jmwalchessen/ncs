...
def visualize_observed_and_diffusion_transposed(variance, figname, n, model_name):
    ...
    cbar = ax.cax.colorbar(im)
    cbar.ax.tick_params(labelsize=15)
    fig.text(x = .27, y = .95, s = "Parameter U-Net", fontsize = 25)
    plt.tight_layout()
...
figname = "figures/gp_parameter_visualization_model7_random05_transposed.png"
visualize_observed_and_diffusion_transposed(variance, figname, n, model_name)