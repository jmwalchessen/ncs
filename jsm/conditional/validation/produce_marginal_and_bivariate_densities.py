...
data_generation_folder = (append_directory(4) + "/validation/unparameterized/conditional_masked/gaussian_process/generate_data")
...
def produce_true_and_generated_marginal_densities(mask, minX, maxX, minY, maxY, n, variance, lengthscale,
    ...
    axs[0,0].plot(matrix_missing_index1[1], matrix_missing_index1[0], "ro", markersize = 20, linewidth = 20)
    ...
    axs[0,2].plot(matrix_missing_index2[1], matrix_missing_index2[0], "ro", markersize = 20, linewidth = 20)
    ...
    axs[1,0].plot(matrix_missing_index3[1], matrix_missing_index3[0], "ro", markersize = 20, linewidth = 20)
    ...
    axs[1,2].plot(matrix_missing_index4[1], matrix_missing_index4[0], "ro", markersize = 20, linewidth = 20)
...
def produce_true_and_generated_bivariate_density(mask, minX, maxX, minY, maxY, n, variance, lengthscale,
    ...
    plt.ylim(-2,2)
    axs[1].set_title("Marginal")
    axs[1].legend(handles = [blue_patch, orange_patch],labels = ['true', 'diffusion'])
    plt.savefig(figname)
    plt.clf()
...
device = "cuda:0"
p = .5
mask = np.load((data_generation_folder + "/data/gpmodel5/ref_image1/mask.npy"))
ref_image = (np.load((data_generation_folder + "/data/gpmodel5/ref_image1/ref_image1.npy")))
minX = -10
maxX = 10
minY = -10
maxY = 10
...
mask_type = "random50"
folder_name = (data_generation_folder + "/data/gpmodel5/ref_image1/marginal_density")
