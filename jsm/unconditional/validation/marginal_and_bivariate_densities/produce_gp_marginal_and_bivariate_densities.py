...
def produce_true_and_generated_bivariate_densities1(minX, maxX, minY, maxY, n, variance, lengthscale,
    ...
    axs[0,1].set_xticks(ticks = [0,7,15,23,31], labels = [-10,-5,0,5,10])
    axs[0,1].set_yticks(ticks = [0,7,15,23,31], labels = [-10,-5,0,5,10])
    #location1 = index_to_spatial_location(minX, maxX, minY, maxY, n, index1)
    #rlocation1 = (round(location1[0],2), round(location1[1],2))
    #location2 = index_to_spatial_location(minX, maxX, minY, maxY, n, index2)
    #rlocation2 = (round(location2[0],2), round(location2[1],2))
    ...
    axs[0,3].set_xticks(ticks = [0,7,15,23,31], labels = [-10,-5,0,5,10])
    axs[0,3].set_yticks(ticks = [0,7,15,23,31], labels = [-10,-5,0,5,10])
    ...
    axs[1,1].set_xticks(ticks = [0,7,15,23,31], labels = [-10,-5,0,5,10])
    axs[1,1].set_yticks(ticks = [0,7,15,23,31], labels = [-10,-5,0,5,10])
    ...
    axs[1,3].set_xticks(ticks = [0,7,15,23,31], labels = [-10,-5,0,5,10])
    axs[1,3].set_yticks(ticks = [0,7,15,23,31], labels = [-10,-5,0,5,10])
