...
def produce_true_and_generated_marginal_densities(n, true_number_of_replicates,
                                                   matrix_index1,
    ...
    n = 32
    df = 3
    tvectors, tsamples = generate_student_nugget(minX, maxX, minY, maxX, n, variance, lengthscale,
                                                 df, true_number_of_replicates, seed_value)
    #conditional_vectors is shape (number of replicates, m)
    marginal_density1 = (tsamples[:,0,matrix_index1[0],matrix_index1[1]]).reshape((true_number_of_replicates,1))
    marginal_density2 = (tsamples[:,0,matrix_index2[0],matrix_index2[1]]).reshape((true_number_of_replicates,1))
    marginal_density3 = (tsamples[:,0,matrix_index3[0],matrix_index3[1]]).reshape((true_number_of_replicates,1))
    marginal_density4 = (tsamples[:,0,matrix_index4[0],matrix_index4[1]]).reshape((true_number_of_replicates,1))
    ...
    axs[0,0].imshow(tsamples[0,:,:].reshape((n,n)), vmin = -2, vmax = 2)
    ...
    axs[0,1].set_yticks(ticks = [0,.1,.2,.3,.4,.5,.6], labels = [0,.1,.2,.3,.4,.5,.6])
    ...
    generated_pdd = pd.DataFrame(generated_marginal_density2,
                                    columns = None)
    axs[0,2].imshow(tsamples[0,:,:].reshape((n,n)), vmin = -2, vmax = 2)
    ...
    axs[0,3].set_yticks(ticks = [0,.1,.2,.3,.4,.5,.6], labels = [0,.1,.2,.3,.4,.5,.6])
    axs[0,3].set_title("Marginal")
    axs[0,3].set(xlabel = None, ylabel = None)
    axs[0,3].set_xlim(-4,4)
    ...
    generated_pdd = pd.DataFrame(generated_marginal_density3,
                                    columns = None)
    axs[1,0].imshow(tsamples[0,:,:].reshape((n,n)), vmin = -2, vmax = 2)
    ...
    axs[1,1].set_yticks(ticks = [0,.1,.2,.3,.4,.5,.6], labels = [0,.1,.2,.3,.4,.5,.6])
    ...
    generated_pdd = pd.DataFrame(generated_marginal_density4,
                                    columns = None)
    axs[1,2].imshow(tsamples[0,:,:].reshape((n,n)), vmin = -2, vmax = 2)
...
def produce_true_and_generated_bivariate_densities(n, number_of_replicates, true_number_of_replicates,
                                                    matrixindex11,
    ...
    tvectors, tsamples = generate_student_nugget(minX, maxX, minY, maxY, n,
                                                 variance, lengthscale, df, true_number_of_replicates,
                                                 seed_value)

    bivariate_density1 = np.concatenate([(tsamples[:,0,int(matrixindex11[0]),int(matrixindex11[1])]).reshape((true_number_of_replicates,1)),
                                        (tsamples[:,0,int(matrixindex12[0]),int(matrixindex12[1])]).reshape((true_number_of_replicates,1))],
                                        axis = 1).reshape((true_number_of_replicates,2))
    bivariate_density2 = np.concatenate([(tsamples[:,0,int(matrixindex21[0]),int(matrixindex21[1])]).reshape((true_number_of_replicates,1)),
                                        (tsamples[:,0,int(matrixindex22[0]),int(matrixindex22[1])]).reshape((true_number_of_replicates,1))],
                                        axis = 1).reshape((true_number_of_replicates,2))
    bivariate_density3 = np.concatenate([(tsamples[:,0,int(matrixindex31[0]),int(matrixindex31[1])]).reshape((true_number_of_replicates,1)),
                                        (tsamples[:,0,int(matrixindex32[0]),int(matrixindex32[1])]).reshape((true_number_of_replicates,1))],
                                        axis = 1).reshape((true_number_of_replicates,2))
    bivariate_density4 = np.concatenate([(tsamples[:,0,int(matrixindex41[0]),int(matrixindex41[1])]).reshape((true_number_of_replicates,1)),
                                        (tsamples[:,0,int(matrixindex42[0]),int(matrixindex42[1])]).reshape((true_number_of_replicates,1))],
                                        axis = 1).reshape((true_number_of_replicates,2))
    ...
    kde1 = sns.kdeplot(data = pdd, x = 'x', y = 'y',
                ax = axs[0,1], hue = 'class', fill = False, levels = [.01,.05,.1,.2,.3,.4,.5,.6,.7,.8,.9],
                 alpha = .8)
    blue_patch = mpatches.Patch(color='blue')
    orange_patch = mpatches.Patch(color='orange')
    axs[0,1].set_xlim(-7.5,7.5)
    axs[0,1].set_ylim(-7.5,7.5)
    ...
    kde1 = sns.kdeplot(data = pdd, x = 'x', y = 'y',
                ax = axs[0,3], hue = 'class', fill = False, levels = [.01,.05,.1,.2,.3,.4,.5,.6,.7,.8,.9],
                alpha = .8)
    blue_patch = mpatches.Patch(color='blue')
    orange_patch = mpatches.Patch(color='orange')
    axs[0,3].set_xlim(-7.5,7.5)
    axs[0,3].set_ylim(-7.5,7.5)
    ...
    kde1 = sns.kdeplot(data = pdd, x = 'x', y = 'y',
                ax = axs[1,1], hue = 'class', fill = False, levels = [.01,.05,.1,.2,.3,.4,.5,.6,.7,.8,.9],
                alpha = .8)
    blue_patch = mpatches.Patch(color='blue')
    orange_patch = mpatches.Patch(color='orange')
    axs[1,1].set_xlim(-7.5,7.5)
    axs[1,1].set_ylim(-7.5,7.5)
    ...
    blue_patch = mpatches.Patch(color='blue')
    orange_patch = mpatches.Patch(color='orange')
    axs[1,3].set_xlim(-7.5,7.5)
    axs[1,3].set_ylim(-7.5,7.5)
...
matrix_index4 = (28,24)
seed_value = 234399
unconditional_generated_samples = np.load(("model5_beta_min_max_01_20_random0_1000.npy"))
true_number_of_replicates = 10000
figname = "tunconditional_marginal_density_model5.png"

produce_true_and_generated_marginal_densities(n, true_number_of_replicates,
                                                   matrix_index1,
                                                   matrix_index2, matrix_index3, matrix_index4,
                                                   unconditional_generated_samples,
                                                   seed_value, figname)
...
matrixindex41 = (16,10)
matrixindex42 = (16,20)
figname = "tunconditional_bivariate_1000_model5.png"
true_number_of_replicates = 1000
seed_value = 8623546
produce_true_and_generated_bivariate_densities(n, number_of_replicates, true_number_of_replicates,
                                                    matrixindex11,
                                                    matrixindex12, matrixindex21, matrixindex22,
                                                    matrixindex31, matrixindex32, matrixindex41,
                                                    matrixindex42, unconditional_generated_samples,
