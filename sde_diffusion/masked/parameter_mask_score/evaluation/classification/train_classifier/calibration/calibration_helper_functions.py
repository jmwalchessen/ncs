...
def load_images(model_name, file_name):
...
def process_images(number_of_replicates, seed_value, model_name, file_name, n, crop_size):

    true_images = generate_true_images(number_of_replicates, seed_value)
    diffusion_images = load_images(model_name, file_name)
