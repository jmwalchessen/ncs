...
mask = np.load((home_folder + "/trained_score_models/vpsde/model11_mask.npy"))
...
for i in range(0,10):
    ...
    figname = ("visualizations/models/model11/fixed50_variance_.4_lengthscale_7_observed_and_generated_samples_" + str(i) + ".png")
