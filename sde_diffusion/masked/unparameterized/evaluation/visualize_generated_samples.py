...
score_model.load_state_dict(th.load((home_folder + "/trained_score_models/vpsde/model5_beta_min_max_01_20_random050_masks.pth")))
score_model.eval()
...
for i in range(0,10):
    ...
    figname = ("visualizations/models/model5/observed_and_generated_samples_" + str(i) + ".png")
