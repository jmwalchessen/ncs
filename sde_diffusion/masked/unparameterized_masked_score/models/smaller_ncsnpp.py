...
# only 3 resolutions rather than 4 resolutions, this is the same size as original unet model
# with 256 features, and about 4 times smaller than unet with 512 features, and about 4 times
# larger than unet with 128 features
...
class NCSNpp(nn.Module):
  ...
  def __init__(self, config):
    ...
    self.all_resolutions = all_resolutions = [config.data.image_size // (2 ** i) 
