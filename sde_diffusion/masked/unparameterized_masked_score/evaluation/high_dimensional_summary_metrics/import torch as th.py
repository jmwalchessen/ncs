...
def generate_joint_ncs_images_multiple_lengthscales(masked_true_images_file, mask_file, vpsde, score_model,
                                              lengthscales, variance, ncs_images_file, nrep, batches_per_call, calls, n):
...
n = 32
generate_joint_ncs_images_multiple_lengthscales(masked_true_images_file, mask_file, sdevp, score_model, lengthscales, variance,
