...
classifier_file = "smaller_cnnclassifier_maxpool_classifier_model6_lengthscale_1.6_variance_0.4_epochs_500_parameters.pth"
produce_weights(model_name, evaluation_file_name, n, crop_size, classifier, classifier_name, classifier_file)