...
def produce_weights(model_name, evaluation_file_name, n, crop_size, classifier_name, classifier_file):
...
def produce_calibrated_weights(model_name, evaluation_file_name, n, crop_size, classifier_name, classifier_file,
...
def visualize_weights(model_name, evaluation_file_name, n, crop_size, classifier_name, classifier_file):
...
def visualize_calibrated_weights(model_name, evaluation_file_name, n, crop_size, classifier_name, classifier_file,
                                 calibrated_model_name, calibrated_model_file):

    weights = produce_calibrated_weights(model_name, evaluation_file_name, n, crop_size, classifier_name, classifier_file,
                                         calibrated_model_name, calibrated_model_file)
    ...
    plt.axvline(1, color='red', linestyle = 'dashed')
    plt.legend(labels = ['Weights'])
    plt.savefig("calibrated_weights.png")
...
visualize_calibrated_weights(model_name, evaluation_file_name, n, crop_size, classifier_name,
