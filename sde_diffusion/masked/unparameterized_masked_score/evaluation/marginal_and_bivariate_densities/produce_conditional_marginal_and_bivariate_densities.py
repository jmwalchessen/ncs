...
conditional_samples = np.load((data_generation_folder + "/data/model5/ref_image2/diffusion/model5_random025_beta_min_max_01_20_1000.npy"))
...
device = "cuda:0"
p = .025
mask = np.load((data_generation_folder + "/data/model5/ref_image2/mask.npy"))
ref_image = (np.load((data_generation_folder + "/data/model5/ref_image2/ref_image.npy")))
minX = -10
maxX = 10
minY = -10
maxY = 10
...
mask_type = "random0"
folder_name = (data_generation_folder + "/data/model5/ref_image2/marginal_density")
...
for i in range(0, m, 20):
    ...
    figname = (folder_name + "/marginal_density_model5_" + str(int(true_missing_matrix_index[0]))
...
indices1 = [480]
indices2 = [450,451,449,447,479,481,482,483,484,485,544]

for i in indices1:
    for j in indices2:
        missing_index1 = i
        missing_index2 = j
        folder_name = (data_generation_folder + "/data/model5/ref_image2/bivariate_density")
