...
matrix_index = (15,15)
unconditional_generated_samples = np.load(diffusion_generation_folder + "/data/model3/ref_image1/diffusion/model3_random0_beta_min_max_01_20_1000.npy")
...
for i in range(0, n, 4):
    for j in range(0, n, 4):
        ...
        figname = (diffusion_generation_folder + "/data/model3/ref_image1/marginal_density/model3_marginal_density_" + str(i) + "_" + str(j) + ".png")
...
"""
indices1 = [(15+i,15) for i in range(-4,4)]
indices2 = [(15,15)]
...
for i in indices1:
    for j in indices2:
        ...
        folder_name = (diffusion_generation_folder + "/data/model3/ref_image1/bivariate_density/")
        figname = (folder_name + "/bivariate_density_model3_" + str(iindex) + "_" + str(jindex) + ".png")
        seed_value = np.random.randint(0, 100000, 1)[0]
