...
condsim_file_name = "data/model1/ref_image1/mcmc_interpolation/mcmc_interpolation_missing_index"
cov_mod = "brown"
neighbors = 7
n = 32
nrep = 100
missing_index_start = 220
missing_index_end = 260
...
def produce_mcmc_interpolation_multiple_pixels(n, range_value, smooth_value, nugget, cov_mod,
    ...
    subprocess.run(["Rscript", "conditional_simulation_multiple_pixels.R", str(range_value),
                    ...
                    str(condsim_file_name), str(cov_mod), str(neighbors), str(n), str(n),
