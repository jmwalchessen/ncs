...
def return_timings_multiple_ranges(tnrep):
    ...
    model_names = ["model5/model5_wo_l2_beta_min_max_01_20_obs_num_1_10_smooth_1.5_range_3_channel_mask.pth"]
    ...
    for i,range_value in enumerate(range_values):
        timing_file = "data/model" + str(model_versions[i]) + "_ncs_timing_array_azure_gpu_8_10_nrep_50.npy"
