...
def return_timings_multiple_ranges(tnrep):
    ...
    model_names = ["model6/model6_wo_l2_beta_min_max_01_20_obs_num_1_10_smooth_1.5_range_1_channel_mask.pth",
                   ...
                   "model8/model5_beta_min_max_01_20_obs_num_1_10_smooth_1.5_range_4_channel_mask.pth",
                   "model9/model9_beta_min_max_01_20_obs_num_1_10_smooth_1.5_range_5_channel_mask.pth"]
    model_versions = [6,7,5,8,9]
    range_values = [float(i) for i in range(1,6)]
    smooth_value = 1.5
    n = 31
    number_of_locations_list = [i for i in range(1,8)]
    for i,range_value in enumerate(range_values):
        timing_file = "data/" + model_versions[i] + "_ncs_timing_array_azure_gpu_1_7_nrep_50.npy"
