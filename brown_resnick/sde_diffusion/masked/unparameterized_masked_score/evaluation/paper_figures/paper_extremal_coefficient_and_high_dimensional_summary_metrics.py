...
def visualize_ncs_fcs_and_true_extremal_coefficient_and_high_dimensional_summary_metrics_one_to_seven_range_1(range_value, smooth,
    ...
    for i in range(20):
        ...
        if(i < 5):
            ...
            ax.set_xlabel("")
            ax.set_ylabel("")
            ax.set_xticks([-30,-20,-10,0], [-30,-20,-10,0], fontsize = 15)
            if(i != 5):
                #ax.set_xticks([])
                ax.set_yticks([])
            else:
                #ax.legend(labels = ['true', 'NCS', 'FCS'], fontsize = 13.5)
                ax.set_yticks([0.,.5,1.,1.5,2.], [0.,.5,1.,1.5,2.], fontsize = 15)
            ...
            ax.set_xlabel("")
            ax.set_ylabel("")
            ax.set_xticks([0,5000,10000], [0,5000,10000], fontsize = 15)
            if(i != 15):
                #ax.set_xticks([])
                ax.set_yticks([])
            else:
                #ax.legend(labels = ['true', 'NCS', 'FCS'], fontsize = 13.5)
                ax.set_yticks([0.,0.001,.002, .003], [0.,0.001,.002,.003], fontsize = 15)
