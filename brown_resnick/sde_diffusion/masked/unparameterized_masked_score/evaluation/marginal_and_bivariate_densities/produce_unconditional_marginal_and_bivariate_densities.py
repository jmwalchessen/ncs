...
diffusion_generation_folder = (append_directory(2) + "/diffusion_generation")
sys.path.append(diffusion_generation_folder)
...
matrix_index = (15,15)
seed_value = 201852
unconditional_true_samples = np.load("schlather_samples_range_3_smooth_1.6_4000.npy")
unconditional_generated_samples = np.load(diffusion_generation_folder + "/data/schlather/model2/ref_image1/diffusion/model2_random0_range_3_smooth_1.6_beta_min_max_01_20_1000.npy")
...
for i in range(0, n, 4):
    for j in range(0, n, 4):
        ...
        figname = (diffusion_generation_folder + "/data/schlather/model2/ref_image1/marginal_density/model2_marginal_density_" + str(i) + "_" + str(j) + ".png")
...
for i in indices1:
    for j in indices2:
        ...
        folder_name = (diffusion_generation_folder + "/data/schlather/model2/ref_image1/bivariate_density/")
