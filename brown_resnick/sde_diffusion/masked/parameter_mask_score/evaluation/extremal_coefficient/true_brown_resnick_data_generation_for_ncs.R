...
n <- 32
p <- .05
mask_file <- "data/ncs/model4/true_masks_range_5.0_smooth_1.5_4000.npy"
masked_brfile <- "data/ncs/model4/true_masked_brown_resnick_range_5.0_smooth_1.5_4000.npy"
