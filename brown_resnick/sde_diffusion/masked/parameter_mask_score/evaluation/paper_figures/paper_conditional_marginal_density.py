...
def produce_marginal_density(model_name, image_name, file_name, missing_index, n, nrep):
...
def visualize_marginal_density(model_name, missing_indices, n, nrep, variance, figname):
    ...
    for i in range(0, 5):
        ...
        diffusion_marginal_density = produce_marginal_density(model_name, image_name, file_name, missing_indices[i], n, nrep)
...
visualize_marginal_density(model_name, missing_indices, n, nrep, smooth, figname)