...
score_model = load_score_model("brown", "model1_beta_min_max_01_20_range_10_20_smooth_1_random50_log_parameterized_mask.pth", "eval")
...
calls = 4
p = 0
validation_data_name = "model1_random" + str(p) + "4000.npy"
