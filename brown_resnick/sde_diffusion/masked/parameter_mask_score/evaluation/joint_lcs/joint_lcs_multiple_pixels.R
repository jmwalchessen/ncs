...
joint_lcs <- function(mask_file_name, ref_image_name, n, nrep, range, smooth, nugget, joint_lcs_file) 
{
  np <- import("numpy")
...
joint_lcs_file <- "data/model4/ref_image0/joint_lcs_range_1.0_smooth_1.5_nugget_1e5_4000.npy"
