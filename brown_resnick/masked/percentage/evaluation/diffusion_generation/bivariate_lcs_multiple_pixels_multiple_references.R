...
neighbors <- 7
nrep <- 4000
condsim_file_name <- "bivariate_lcs_4000_neighbors_7_nugget_1e5_random"
...
ps <- c(.01,.05,.1,.25,.5)
produce_bivariate_local_conditional_simulation_multiple_references(indices1, indices2, n, range_value, smooth, nugget, cov_mod,
