...
masked_true_brown_resnick_data_generation_with_variables <- function()
{
  nrep <- 4000
  ...
  n <- 32
  p <- .5
  mask_file <- "data/ncs/model4/true_masks_range_3.0_smooth_1.5_4000_random50.npy"
  masked_brfile <- "data/ncs/model4/true_masked_brown_resnick_range_3.0_smooth_1.5_4000_random50.npy"
