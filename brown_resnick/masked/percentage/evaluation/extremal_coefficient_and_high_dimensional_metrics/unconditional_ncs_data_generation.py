...
score_model = load_score_model("model4_beta_min_max_01_20_random01525_smooth_1.5_range_3_channel_mask.pth", "eval")
...
def generate_unconditional_ncs_images(masked_true_images_file, mask_file, vpsde, score_model, range_value, smooth_value,
...
def generate_unconditional_ncs_images_multiple_percentages(masked_true_images_file, mask_file, vpsde, score_model, range_value, smooth_value,
    ...
    for p in ps:
        ...
        generate_unconditional_ncs_images(current_masked_true_images_file, current_mask_file, vpsde, score_model, range_value, smooth_value,
                                  current_ncs_images_file, batches_per_call, calls, n)

def generate_unconditional_ncs_images_with_variables():
    ...
    n = 32
    ps = [.01,.05,.1,.25,.5]
    generate_unconditional_ncs_images_multiple_percentages(masked_true_images_file, mask_file, sdevp, score_model, range_value, smooth_value,
                                                ncs_images_file, batches_per_call, calls, n, ps)