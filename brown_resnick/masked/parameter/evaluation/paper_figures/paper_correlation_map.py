...
def produce_diffusion_correlation_map_per_pixel(diffusion_images, mask, missing_index, n, nrep,
                                                ref_image):
...
def visualize_true_and_diffusion_correlation_maps(missing_indices, n, nrep,
    ...
    for i in range(0, 5):
        ...
        for i, ax in enumerate(grid):
            ...
            im = ax.imshow(diffusion_cov_images[i,:,:], cmap='viridis', vmin = 0, vmax = 1,
                        alpha = (1-masks[i,:,:].astype(float)))
