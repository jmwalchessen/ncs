...
def produce_bivariate_density(minX, maxX, minY, maxY, n, variance, lengthscale, df,
    ...
    unconditional_vectors, unconditonal_matrices = generate_student_nugget(minX, maxX, minY, maxY, n, variance, lengthscale, df, number_of_replicates)
...
def produce_marginal_density(minX, maxX, minY, maxY, n, variance, lengthscale, df,
...
df = 10
figname = "student_t_df_1_vs_gp_marginal_density.png"
...
unconditional_generated_samples = np.load((home_folder + 
                                           "/evaluation/diffusion_generation/data/model2/ref_image1/diffusion/model2_beta_min_max_01_25_random50_1000.npy"))
figname = "true_vs_generated_marginal_density.png"
