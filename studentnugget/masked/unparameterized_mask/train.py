...
def train_per_multiple_random_masks(config, data_draws, epochs_per_drawn_data,
                             ...
                             smooth_value, range_value, batch_size,
...
score_model_path = "trained_score_models/vpsde/model1_beta_min_max_01_20_1000_random050_log_parameterized_mask.pth"
loss_path = "trained_score_models/vpsde/model1_beta_min_max_01_20_1000_random050_log_parameterized_mask_loss.png"
